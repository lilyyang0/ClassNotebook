...
<html>
	...
	<h4>포로토콜://ip주소:port번호/파일명.확장자</h4>
	<h5>http://localhost:8081/컨텍스트패스/파일.확장자</h5>
	...
	<hr/><!-- 수평선.구분역할 -->
		...
		<ul>
			...
			<li type="disc">프론트엔드 - HTML,CSS,JavaScript, jQuery, Ajax, JSON등</li>
			<li type="circle">백엔드 - Java, JSP/Servlet 등</li>			
			<li type="square">DBMS -오라클,MySQL, MariaDB등</li>			
		</ul>
		<ol>
			<li>ol(ordered list): 순서 목록 type="숫자(기본)|로마대소문자|알파벳대소문자"</li>
			<li type="1">요구사항 개발 프로세스</li>
			<ol>
				<li type="A">도출(Elicitation)</li>
				<li type="a">분석(Analysis)</li>
				<li type="I">명세(Specification)</li>
				<li type="i">확인(Validation)</li>		
			</ol>			
		</ol>
		<hr/>				
		hello~<br/><br/><br/>
